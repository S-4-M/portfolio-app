  ...
  return (
    <div className="weather" id="Weather">
      <div
        ...
        style={{ backgroundImage: `url(${props.backgrounds[0]})` }}
      >
      ...
      <div className="cards-container">
        <div className="card-day today">
          <div className={props.colors[0]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[1]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[2]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[3]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[4]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[5]} id="color">
        ...
        <div className="card-day">
          <div className={props.colors[6]} id="color">
